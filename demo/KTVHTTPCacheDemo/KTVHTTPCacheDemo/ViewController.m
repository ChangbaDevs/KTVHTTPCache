...
- (void)reloadData {
    ...
    MediaItem *item5 = [[MediaItem alloc] initWithTitle:@"张学友 - 我真的受伤了5[测试URLFilter]"
                                              URLString:@"http://lzaiuw.changba.com/userdata/video/940071102.mp4?auth=18398dlkjdasdlkfja"];

    MediaItem *item6 = [[MediaItem alloc] initWithTitle:@"张学友 - 我真的受伤了6[测试URLFilter]"
                                              URLString:@"http://lzaiuw.changba.com/userdata/video/940071102.mp4?auth=asddaskjdkd&id=adklkkkkkkkkk"];

    MediaItem *item7 = [[MediaItem alloc] initWithTitle:@"张学友 - 我真的受伤了7[测试URLFilter]"
                                              URLString:@"https://lzaiuw.changba.com/userdata/video/940071102.mp4?auth=asdda"];
    self.medaiItems = @[item1, item2, item3, item4, item5, item6, item7];
